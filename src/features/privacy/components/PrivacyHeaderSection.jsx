...
<div className="">
    <div className="relative">
      <h1 className='text-white text-center'>Privacy and Policy</h1>
       <div className="bg-white w-full  h-1 absolute top-10"></div>
     </div>
     <div className="ml-5">
        <Link href={"/"} className='text-white'>Home</Link> <span className='text-white'>/</span> <span className='text-white'>Privacy and Policy</span>
     </div>
</div>
