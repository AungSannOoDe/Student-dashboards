...
const useEvent = () => {
  ...
  useEffect(() => {
    ...
    setFetchUrl(`${eventApiUrl}?${queries}`);
  ...
  const { data, isLoading, error } = useSWR(fetchUrl,fechEvent);
