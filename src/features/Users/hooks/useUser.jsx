...
const useUser = () => {
  ...
  useEffect(() => {
    ...
    setFetchUrl(`${voterApiUrl}?${queries}`);
  ...
  const { data, isLoading, error } = useSWR(fetchUrl,fetchVoters);
