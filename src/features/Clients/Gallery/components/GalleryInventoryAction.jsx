...
const GalleryInventoryAction = ({searchRef,searchParams,handleSearchInput,clearSearchInput}) => {
  return (
<div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
  <div className="">
    ...
    <div className="flex items-center space-x-3 w-full md:w-auto">
      <div>
        <Link  href={`/dashboard/gallery/create`} className="py-2 px-4 rounded-sm text-white bg-blue-500 outline-0 "><i className="fa fa-plus" />  Create Gallery</Link>
      </div>
    </div>
  </div>
  )
...
export default GalleryInventoryAction