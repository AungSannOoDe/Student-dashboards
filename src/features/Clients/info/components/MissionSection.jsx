  ...
  return (
    <section ref={sectionRef} className='max-w-7xl mx-auto px-4 py-20'>
      <div className="relative inline-block mb-16 md:mb-20">
        ...
        <div 
          ref={underlineRef} 
          className="w-30 sm:w-32 md:w-[460px] h-2 bg-blue-400 absolute -bottom-3 sm:-bottom-4 md:-bottom-6 left-0"
        />
      </div>

      <div ref={listContainerRef}>
        <ol className='  list-decimal leading-14 text-lg pl-6 md:pl-8 space-y-6 md:space-y-8'>
